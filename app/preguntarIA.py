...
def preguntarIA(sitio, dias, duracion, nivel, objetivo):
    prompt=('Quiero que me muestres una rutina completa de entrenamiento en '+sitio+' para conseguir el objetivo de '+ objetivo+', sin calentamiento, '
            ...
            'que tener consideraciones. No quiero que aparezcan caracteres como este * en la respuesta. En cuanto al formato del texto de la respuesta que me des es MUY IMPORTANTE que en cada línea haya como máximo 14 palabras')
